...
from createdb import generate_embeddings # Python file of Step-1
...
def generate_chat_response(user_query, retrieved_maching_string):
    completion = openai_client.chat.completions.create(
        ...
        messages=[
            #{"role": "system", "content": "You are a helpful assistant specialized about Animals. Include the information only in the context."},
            {"role": "system", "content": "You are a helpful assistant specialized about Animals. Include the information you have but not necessary in the context."},
...
def main():
    ...
    retrieved_maching_string = retrieve_matching_documents(opensearch_client, user_query, limit=2)
